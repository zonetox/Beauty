              ...
              <div className="flex gap-4">
                <label className="flex-1 cursor-pointer">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`p-4 border-2 rounded-lg text-center transition-all ${userType === 'user'
                ...
                <label className="flex-1 cursor-pointer">
                  <input
                    ...
                    className="sr-only"
                  />
                  <div className={`p-4 border-2 rounded-lg text-center transition-all ${userType === 'business'
                    ? 'border-primary bg-primary/5'
                    : 'border-gray-200 hover:border-gray-300'
                    }`}>
