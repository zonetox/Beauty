...
const SidebarLink: React.FC<{ to: string; children: React.ReactNode; end?: boolean }> = ({ to, children, end = false }) => (
  <NavLink
    ...
    className={({ isActive }) =>
      `w-full text-left px-6 py-4 rounded-full font-bold transition-all duration-500 flex items-center gap-4 text-[10px] uppercase tracking-[0.2em] ${isActive
...
const BusinessDashboardSidebar: React.FC = () => {
  return (
    <nav className="bg-transparent space-y-3">
      ...
      <SidebarLink to="/dashboard/bookings">
      ...
      <SidebarLink to="/dashboard/landing">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" /></svg>
        <span>Landing Page</span>
      </SidebarLink>
      <SidebarLink to="/dashboard/services">
      ...
      <SidebarLink to="/dashboard/deals">
      ...
      <div className="pt-6 mt-6 border-t border-primary/10">
        <SidebarLink to="/dashboard/support">
