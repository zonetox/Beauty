...
const BlogPostPage: React.FC = () => {
  ...
  const { getPostBySlug, incrementViewCount, blogPosts } = useBlogData();
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <main className="lg:col-span-2">
            ...
            <img src={getOptimizedSupabaseUrl(post.imageUrl, { width: 1200, quality: 85 })} alt={post.title} className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-lg mb-8" loading="lazy" />
            ...
            <div className="mt-12 border-t pt-8 space-y-8">
              {/* --- Share Section --- */}
              <div>
                <h3 className="text-lg font-semibold text-neutral-dark mb-4">Share this post</h3>
                <div className="flex items-center flex-wrap gap-4">
                  <a href={shareLinks.facebook} target="_blank" rel="noopener noreferrer" className={socialButtonClasses} aria-label="Share on Facebook"><FacebookIcon /></a>
                  <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" className={socialButtonClasses} aria-label="Share on Twitter"><TwitterIcon /></a>
                  <a href={shareLinks.linkedin} target="_blank" rel="noopener noreferrer" className={socialButtonClasses} aria-label="Share on LinkedIn"><LinkedInIcon /></a>
                  <button
