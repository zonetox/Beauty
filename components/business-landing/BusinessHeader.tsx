...
const BusinessHeader: React.FC<BusinessHeaderProps> = ({ business, onBookNowClick }) => {
    ...
    const { currentUser, isFavorite, toggleFavorite } = useUserSession();
    ...
    const navLinkClasses = `py-2 text-sm font-semibold transition-colors ${
        isScrolled ? 'text-neutral-dark hover:text-primary' : 'text-white hover:text-white/80'
    }`;
